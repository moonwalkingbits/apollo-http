...
class Url {
    ...
    constructor(scheme, user, password, host, port, path, query, fragment) {
         ...
         * @type {?string}
         */
        this._scheme = scheme && scheme.length > 0 ? scheme.toLowerCase() : null;
         ...
         * @type {?string}
         */
        this._host = host && host.length > 0 ? host.toLowerCase() : null;
         ...
         * @type {?string}
         */
        this._path = path && path.length > 0 ? this.encodePath(path) : null;
         ...
         * @type {?string}
         */
        this._query = query && query.length > 0 ? this.encodeQuery(query) : null;
         ...
         * @type {?string}
         */
        this._fragment = fragment && fragment.length > 0 ? this.encodeFragment(fragment) : null;
    }
     ...
     */
    get port() {
        return this._port && !this.isStandardPort(this._port) ?
            this._port :
            null;
    }
    ...
    withScheme(scheme) {
        if (
            (scheme.length === 0 && !this._scheme) ||
            (scheme.toLowerCase() === this._scheme)
        ) {
            return this;
        }
    ...
    withHost(host) {
        if (
            (host.length === 0 && !this._host) ||
            (host.toLowerCase() === this._host)
        ) {
            return this;
        }
     ...
     * Implementations ensure the correct encoding as outlined in path.
     *
     * @public
    ...
    withPath(path) {
        ...
        if (
            (encodedPath.length === 0 && !this._path) ||
            (encodedPath === this._path)
        ) {
            return this;
        }
     ...
     * Implementations ensure the correct encoding as outlined in query.
     *
    ...
    withQuery(query) {
        ...
        if (
            (encodedQuery.length === 0 && !this._query) ||
            (encodedQuery === this._query)
        ) {
            return this;
        }
     ...
     * Implementations ensure the correct encoding as outlined in fragment.
     *
    ...
    withFragment(fragment) {
        ...
        if (
            (encodedFragment.length === 0 && !this._fragment) ||
            (encodedFragment === this._fragment)
        ) {
            return this;
        }
